...
/**
 * Main entry point for Lab 02 correction.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(alice);                // Alice — Balance: £0.00
        alice.deposit(2000.0);                    // Deposited £2000.00 → Balance: £2000.00
        alice.withdraw(300.0);                    // Withdrew  £300.00  → Balance: £1700.00
        alice.withdraw(5000.0);                   // ERROR: Insufficient funds.
        alice.deposit(-50.0);                     // ERROR: Deposit amount must be positive.
